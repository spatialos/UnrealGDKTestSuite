...
4. Initialise the project: from the root directory of your project, run `workers/unreal/Game/Scripts/Codegen.bat`.
...
9.  Build the SpatialOS Unreal engine for SpatialOS local deployment: in a terminal window, run `workers/unreal/Game/Scripts/Build.bat --local`.
