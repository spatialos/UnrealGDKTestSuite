...
#include "TestBoolReplicationHandoverDataAddComponentOp.h"
...
const FHandoverHandlePropertyMap& USpatialTypeBinding_TestBoolReplication::GetHandoverHandlePropertyMap() const
{
...
void USpatialTypeBinding_TestBoolReplication::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	...
	RepHandleToPropertyMap.Add(17, FRepHandleData(Class, {"TestBool"}, {0}, COND_None, REPNOTIFY_OnChanged));
...
void USpatialTypeBinding_TestBoolReplication::BindToView(bool bIsClient)
{
	...
	if (Interop->GetNetDriver()->GetNetMode() == NM_Client)
	{
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
...
worker::Entity USpatialTypeBinding_TestBoolReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	improbable::unreal::generated::testboolreplication::TestBoolReplicationSingleClientRepData::Data SingleClientTestBoolReplicationData;
	improbable::unreal::generated::testboolreplication::TestBoolReplicationSingleClientRepData::Update SingleClientTestBoolReplicationUpdate;
	bool bSingleClientTestBoolReplicationUpdateChanged = false;
	improbable::unreal::generated::testboolreplication::TestBoolReplicationMultiClientRepData::Data MultiClientTestBoolReplicationData;
	improbable::unreal::generated::testboolreplication::TestBoolReplicationMultiClientRepData::Update MultiClientTestBoolReplicationUpdate;
	bool bMultiClientTestBoolReplicationUpdateChanged = false;
	improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::Data TestBoolReplicationHandoverData;
	improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::Update TestBoolReplicationHandoverDataUpdate;
	bool bTestBoolReplicationHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientTestBoolReplicationUpdate, bSingleClientTestBoolReplicationUpdateChanged, MultiClientTestBoolReplicationUpdate, bMultiClientTestBoolReplicationUpdateChanged, TestBoolReplicationHandoverDataUpdate, bTestBoolReplicationHandoverDataUpdateChanged);
	SingleClientTestBoolReplicationUpdate.ApplyTo(SingleClientTestBoolReplicationData);
	MultiClientTestBoolReplicationUpdate.ApplyTo(MultiClientTestBoolReplicationData);
	TestBoolReplicationHandoverDataUpdate.ApplyTo(TestBoolReplicationHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::testboolreplication::TestBoolReplicationSingleClientRepData>(SingleClientTestBoolReplicationData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testboolreplication::TestBoolReplicationMultiClientRepData>(MultiClientTestBoolReplicationData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData>(TestBoolReplicationHandoverData, WorkersOnly)
		...
		.AddComponent<improbable::unreal::generated::testboolreplication::TestBoolReplicationCrossServerRPCs>(improbable::unreal::generated::testboolreplication::TestBoolReplicationCrossServerRPCs::Data{}, WorkersOnly)
...
void USpatialTypeBinding_TestBoolReplication::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	...
	improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::Update HandoverDataUpdate;
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}
...
void USpatialTypeBinding_TestBoolReplication::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	...
	auto* HandoverDataAddOp = Cast<UTestBoolReplicationHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
...
void USpatialTypeBinding_TestBoolReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testboolreplication::TestBoolReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestBoolReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testboolreplication::TestBoolReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestBoolReplication& ParentValue = *(static_cast<ATestBoolReplication const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestBoolReplication&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
				OutUpdate.set_field_owner0(SpatialConstants::NULL_OBJECT_REF);
				(const_cast<ATestBoolReplication&>(ParentValue)).Owner_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 14: // field_role0
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestBoolReplication&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
				OutUpdate.set_field_instigator0(SpatialConstants::NULL_OBJECT_REF);
				(const_cast<ATestBoolReplication&>(ParentValue)).Instigator_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		...
		case 17: // field_testbool0
		{
			bool Value = static_cast<UBoolProperty*>(Property)->GetPropertyValue(Data);

			OutUpdate.set_field_testbool0(Value);
			break;
		}
	default:
...
void USpatialTypeBinding_TestBoolReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::Update& OutUpdate) const
{
}
...
void USpatialTypeBinding_TestBoolReplication::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testboolreplication::TestBoolReplicationMultiClientRepData::Update& Update) const
{
	...
	if (!Update.field_testbool0().empty())
	{
		// field_testbool0
		uint16 Handle = 17;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = (*Update.field_testbool0().data());
...
void USpatialTypeBinding_TestBoolReplication::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testboolreplication::TestBoolReplicationHandoverData::Update& Update) const
{
}
...
void USpatialTypeBinding_TestBoolReplication::Server_ReportReplication_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		{
			RPCPayload.set_field_repbool0(StructuredParams.RepBool);
		}
...
void USpatialTypeBinding_TestBoolReplication::Server_ReportReplication_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testboolreplication::TestBoolReplicationServerRPCs::Commands::Serverreportreplication>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		...
		{
			Parameters.RepBool = Op.Request.field_repbool0();
		}
