...
const FHandoverHandlePropertyMap& USpatialTypeBinding_TestFStringReplication::GetHandoverHandlePropertyMap() const
{
...
void USpatialTypeBinding_TestFStringReplication::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	...
	RepHandleToPropertyMap.Add(17, FRepHandleData(Class, {"TestFString"}, {0}, COND_None, REPNOTIFY_OnChanged));
...
void USpatialTypeBinding_TestFStringReplication::BindToView(bool bIsClient)
{
	...
	if (Interop->GetNetDriver()->GetNetMode() == NM_Client)
	{
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
...
worker::Entity USpatialTypeBinding_TestFStringReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* ActorChannel) const
{
	...
	improbable::unreal::generated::testfstringreplication::TestFStringReplicationSingleClientRepData::Data SingleClientTestFStringReplicationData;
	improbable::unreal::generated::testfstringreplication::TestFStringReplicationSingleClientRepData::Update SingleClientTestFStringReplicationUpdate;
	bool bSingleClientTestFStringReplicationUpdateChanged = false;
	improbable::unreal::generated::testfstringreplication::TestFStringReplicationMultiClientRepData::Data MultiClientTestFStringReplicationData;
	improbable::unreal::generated::testfstringreplication::TestFStringReplicationMultiClientRepData::Update MultiClientTestFStringReplicationUpdate;
	bool bMultiClientTestFStringReplicationUpdateChanged = false;
	improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData::Data TestFStringReplicationHandoverData;
	improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData::Update TestFStringReplicationHandoverDataUpdate;
	bool bTestFStringReplicationHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, ActorChannel, SingleClientTestFStringReplicationUpdate, bSingleClientTestFStringReplicationUpdateChanged, MultiClientTestFStringReplicationUpdate, bMultiClientTestFStringReplicationUpdateChanged, TestFStringReplicationHandoverDataUpdate, bTestFStringReplicationHandoverDataUpdateChanged);
	SingleClientTestFStringReplicationUpdate.ApplyTo(SingleClientTestFStringReplicationData);
	MultiClientTestFStringReplicationUpdate.ApplyTo(MultiClientTestFStringReplicationData);
	TestFStringReplicationHandoverDataUpdate.ApplyTo(TestFStringReplicationHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::testfstringreplication::TestFStringReplicationSingleClientRepData>(SingleClientTestFStringReplicationData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testfstringreplication::TestFStringReplicationMultiClientRepData>(MultiClientTestFStringReplicationData, WorkersOnly)
...
void USpatialTypeBinding_TestFStringReplication::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* ActorChannel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}
...
void USpatialTypeBinding_TestFStringReplication::ReceiveAddComponent(USpatialActorChannel* ActorChannel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	...
	auto* HandoverDataAddOp = Cast<UTestFStringReplicationHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
...
void USpatialTypeBinding_TestFStringReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::testfstringreplication::TestFStringReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestFStringReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::testfstringreplication::TestFStringReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestFStringReplication& ParentValue = *(static_cast<ATestFStringReplication const*>(ActorChannel->Actor));
			...
			else
			{
				...
				//(const_cast<ATestFStringReplication&>(ParentValue)).Owner_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 14: // field_role0
		...
		case 15: // field_instigator0
		{
			...
			else
			{
				...
				//(const_cast<ATestFStringReplication&>(ParentValue)).Instigator_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		...
		case 17: // field_testfstring0
		{
			FString Value = *(reinterpret_cast<FString const*>(Data));

			OutUpdate.set_field_testfstring0(TCHAR_TO_UTF8(*Value));
			break;
		}
	default:
...
void USpatialTypeBinding_TestFStringReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData::Update& OutUpdate) const
{
}
...
void USpatialTypeBinding_TestFStringReplication::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testfstringreplication::TestFStringReplicationMultiClientRepData::Update& Update) const
{
	...
	if (!Update.field_owner0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestFStringReplication&>(ParentValue)).Owner_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_instigator0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestFStringReplication&>(ParentValue)).Instigator_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_testfstring0().empty())
	{
		// field_testfstring0
		uint16 Handle = 17;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = FString(UTF8_TO_TCHAR((*Update.field_testfstring0().data()).c_str()));
...
void USpatialTypeBinding_TestFStringReplication::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testfstringreplication::TestFStringReplicationHandoverData::Update& Update) const
{
}
...
void USpatialTypeBinding_TestFStringReplication::Server_ReportReplication_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		{
			RPCPayload.set_field_repfstring0(TCHAR_TO_UTF8(*StructuredParams.RepFString));
		}
...
void USpatialTypeBinding_TestFStringReplication::Server_ReportReplication_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testfstringreplication::TestFStringReplicationServerRPCs::Commands::Serverreportreplication>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		...
		{
			Parameters.RepFString = FString(UTF8_TO_TCHAR(Op.Request.field_repfstring0().c_str()));
		}
