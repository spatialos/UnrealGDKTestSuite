...
void USpatialTypeBinding_TestSuiteCharacter::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	...
	HandoverHandleToPropertyMap.Add(4, FHandoverHandleData(Class, {"CharacterMovement", "PredictionHandoverData"}));
	HandoverHandleToPropertyMap.Add(5, FHandoverHandleData(Class, {"CharacterMovement", "Velocity"}));
