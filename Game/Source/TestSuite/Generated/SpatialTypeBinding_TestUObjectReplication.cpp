...
const FRepHandlePropertyMap& USpatialTypeBinding_TestUObjectReplication::GetRepHandlePropertyMap() const
{
	return RepHandleToPropertyMap;
}

const FHandoverHandlePropertyMap& USpatialTypeBinding_TestUObjectReplication::GetHandoverHandlePropertyMap() const
{
	return HandoverHandleToPropertyMap;
}

UClass* USpatialTypeBinding_TestUObjectReplication::GetBoundClass() const
{
	return ATestUObjectReplication::StaticClass();
}

void USpatialTypeBinding_TestUObjectReplication::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	Super::Init(InInterop, InPackageMap);

	RPCToSenderMap.Emplace("Server_ReportReplication", &USpatialTypeBinding_TestUObjectReplication::Server_ReportReplication_SendRPC);

	UClass* Class = FindObject<UClass>(ANY_PACKAGE, TEXT("TestUObjectReplication"));
...
void USpatialTypeBinding_TestUObjectReplication::BindToView(bool bIsClient)
{
	...
	{
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::ComponentId))
			{
				return;
			}
		...
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::ComponentId))
			{
				return;
			}
			USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
	...
	ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationNetMulticastRPCs>([this](
		const worker::ComponentUpdateOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationNetMulticastRPCs>& Op)
	{
		// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
		if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationNetMulticastRPCs::ComponentId))
		{
			return;
		}
	...
	using ServerRPCCommandTypes = improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands;
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Serverreportreplication>(std::bind(&USpatialTypeBinding_TestUObjectReplication::Server_ReportReplication_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Serverreportreplication>(std::bind(&USpatialTypeBinding_TestUObjectReplication::Server_ReportReplication_OnCommandResponse, this, std::placeholders::_1)));
}

void USpatialTypeBinding_TestUObjectReplication::UnbindFromView()
{
	ViewCallbacks.Reset();
}

worker::Entity USpatialTypeBinding_TestUObjectReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* ActorChannel) const
{
	...
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::Data SingleClientTestUObjectReplicationData;
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::Update SingleClientTestUObjectReplicationUpdate;
	bool bSingleClientTestUObjectReplicationUpdateChanged = false;
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::Data MultiClientTestUObjectReplicationData;
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::Update MultiClientTestUObjectReplicationUpdate;
	bool bMultiClientTestUObjectReplicationUpdateChanged = false;
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData::Data TestUObjectReplicationHandoverData;
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData::Update TestUObjectReplicationHandoverDataUpdate;
	bool bTestUObjectReplicationHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, ActorChannel, SingleClientTestUObjectReplicationUpdate, bSingleClientTestUObjectReplicationUpdateChanged, MultiClientTestUObjectReplicationUpdate, bMultiClientTestUObjectReplicationUpdateChanged, TestUObjectReplicationHandoverDataUpdate, bTestUObjectReplicationHandoverDataUpdateChanged);
	SingleClientTestUObjectReplicationUpdate.ApplyTo(SingleClientTestUObjectReplicationData);
	MultiClientTestUObjectReplicationUpdate.ApplyTo(MultiClientTestUObjectReplicationData);
	TestUObjectReplicationHandoverDataUpdate.ApplyTo(TestUObjectReplicationHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData>(SingleClientTestUObjectReplicationData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData>(MultiClientTestUObjectReplicationData, WorkersOnly)
...
void USpatialTypeBinding_TestUObjectReplication::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* ActorChannel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData>(EntityId.ToSpatialEntityId(), SingleClientUpdate);
	}
	if (bMultiClientUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData>(EntityId.ToSpatialEntityId(), MultiClientUpdate);
	}
	if (bHandoverDataUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}

void USpatialTypeBinding_TestUObjectReplication::SendRPCCommand(UObject* TargetObject, const UFunction* const Function, void* Parameters)
{
	TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
...
void USpatialTypeBinding_TestUObjectReplication::ReceiveAddComponent(USpatialActorChannel* ActorChannel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	auto* SingleClientAddOp = Cast<UTestUObjectReplicationSingleClientRepDataAddComponentOp>(AddComponentOp);
	if (SingleClientAddOp)
	{
		auto Update = improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::Update::FromInitialData(*SingleClientAddOp->Data.data());
		ReceiveUpdate_SingleClient(ActorChannel, Update);
		return;
	}
	auto* MultiClientAddOp = Cast<UTestUObjectReplicationMultiClientRepDataAddComponentOp>(AddComponentOp);
	if (MultiClientAddOp)
	{
		auto Update = improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::Update::FromInitialData(*MultiClientAddOp->Data.data());
		ReceiveUpdate_MultiClient(ActorChannel, Update);
		return;
	}
	auto* HandoverDataAddOp = Cast<UTestUObjectReplicationHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
...
void USpatialTypeBinding_TestUObjectReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestUObjectReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestUObjectReplication& ParentValue = *(static_cast<ATestUObjectReplication const*>(ActorChannel->Actor));
			...
			else
			{
				...
				//(const_cast<ATestUObjectReplication&>(ParentValue)).Owner_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 14: // field_role0
		...
		case 15: // field_instigator0
		{
			...
			else
			{
				...
				//(const_cast<ATestUObjectReplication&>(ParentValue)).Instigator_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		...
		case 17: // field_dynamicallycreatedactor0
		{
			...
			if (Value != nullptr)
			{
				...
				{
					OutUpdate.set_field_dynamicallycreatedactor0(*ObjectRef);
				}
			}
			else
			{
				OutUpdate.set_field_dynamicallycreatedactor0(SpatialConstants::NULL_OBJECT_REF);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).DynamicallyCreatedActor_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 18: // field_stablynameduobject0
		{
			...
			else
			{
				...
				//(const_cast<ATestUObjectReplication&>(ParentValue)).StablyNamedUObject_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 19: // field_constobj0
		{
			UTestUObject* Value = *(reinterpret_cast<UTestUObject* const*>(Data));
			const ATestUObjectReplication& ParentValue = *(static_cast<ATestUObjectReplication const*>(ActorChannel->Actor));
			...
			if (Value != nullptr)
			{
				...
				{
					OutUpdate.set_field_constobj0(*ObjectRef);
				}
			}
			else
			{
				OutUpdate.set_field_constobj0(SpatialConstants::NULL_OBJECT_REF);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).ConstObj_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
	default:
...
void USpatialTypeBinding_TestUObjectReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestUObjectReplication::ReceiveUpdate_SingleClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::Update& Update) const
{
...
void USpatialTypeBinding_TestUObjectReplication::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::Update& Update) const
{
	AActor* TargetObject = ActorChannel->Actor;
	ActorChannel->PreReceiveSpatialUpdate(TargetObject);
	...
	const bool bAutonomousProxy = ActorChannel->IsClientAutonomousProxy(improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationClientRPCs::ComponentId);
	...
	if (!Update.field_owner0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).Owner_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_instigator0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).Instigator_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_dynamicallycreatedactor0().empty())
	{
		// field_dynamicallycreatedactor0
		uint16 Handle = 17;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			improbable::unreal::UnrealObjectRef ObjectRef = (*Update.field_dynamicallycreatedactor0().data());
			check(ObjectRef != SpatialConstants::UNRESOLVED_OBJECT_REF);
			if (ObjectRef == SpatialConstants::NULL_OBJECT_REF)
			{
				//(const_cast<ATestUObjectReplication&>(ParentValue)).DynamicallyCreatedActor_Context = &SpatialConstants::NULL_OBJECT_REF;
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).DynamicallyCreatedActor_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_stablynameduobject0().empty())
	{
		// field_stablynameduobject0
		uint16 Handle = 18;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			improbable::unreal::UnrealObjectRef ObjectRef = (*Update.field_stablynameduobject0().data());
			check(ObjectRef != SpatialConstants::UNRESOLVED_OBJECT_REF);
			if (ObjectRef == SpatialConstants::NULL_OBJECT_REF)
			{
				//(const_cast<ATestUObjectReplication&>(ParentValue)).StablyNamedUObject_Context = &SpatialConstants::NULL_OBJECT_REF;
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).StablyNamedUObject_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_constobj0().empty())
	{
		// field_constobj0
		uint16 Handle = 19;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			improbable::unreal::UnrealObjectRef ObjectRef = (*Update.field_constobj0().data());
			check(ObjectRef != SpatialConstants::UNRESOLVED_OBJECT_REF);
			if (ObjectRef == SpatialConstants::NULL_OBJECT_REF)
			{
				//(const_cast<ATestUObjectReplication&>(ParentValue)).ConstObj_Context = &SpatialConstants::NULL_OBJECT_REF;
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ATestUObjectReplication&>(ParentValue)).ConstObj_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
...
void USpatialTypeBinding_TestUObjectReplication::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationHandoverData::Update& Update) const
{
}

void USpatialTypeBinding_TestUObjectReplication::ReceiveUpdate_NetMulticastRPCs(worker::EntityId EntityId, const improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationNetMulticastRPCs::Update& Update)
{
}
void USpatialTypeBinding_TestUObjectReplication::Server_ReportReplication_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in TestUObjectReplication.generated.h (in a macro that is then put in TestUObjectReplication.h UCLASS macro)
	TestUObjectReplication_eventServer_ReportReplication_Parms StructuredParams = *static_cast<TestUObjectReplication_eventServer_ReportReplication_Parms*>(Parameters);
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		// Build RPC Payload.
		improbable::unreal::generated::testuobjectreplication::ServerReportReplicationRequest RPCPayload;
		{
			if (StructuredParams.RepDynamicallyCreatedActor != nullptr)
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromObject(StructuredParams.RepDynamicallyCreatedActor);
				if (!NetGUID.IsValid())
				{
					if (StructuredParams.RepDynamicallyCreatedActor->IsFullNameStableForNetworking())
					{
						NetGUID = PackageMap->ResolveStablyNamedObject(StructuredParams.RepDynamicallyCreatedActor);
					}
				}
				const improbable::unreal::UnrealObjectRef* ObjectRef = PackageMap->GetUnrealObjectRefFromNetGUID(NetGUID);
				if ((*ObjectRef) == SpatialConstants::UNRESOLVED_OBJECT_REF)
				{
					UE_LOG(LogSpatialGDKInterop, Log, TEXT("%s: RPC Server_ReportReplication queued. StructuredParams.RepDynamicallyCreatedActor is unresolved."), *Interop->GetSpatialOS()->GetWorkerId());
					return {Cast<UObject>(StructuredParams.RepDynamicallyCreatedActor)};
				}
				else
				{
					RPCPayload.set_field_repdynamicallycreatedactor0(*ObjectRef);
				}
			}
			else
			{
				RPCPayload.set_field_repdynamicallycreatedactor0(SpatialConstants::NULL_OBJECT_REF);
				//
			}
		}
		{
			if (StructuredParams.RepStablyNamedUObject != nullptr)
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromObject(StructuredParams.RepStablyNamedUObject);
				if (!NetGUID.IsValid())
				{
					if (StructuredParams.RepStablyNamedUObject->IsFullNameStableForNetworking())
					{
						NetGUID = PackageMap->ResolveStablyNamedObject(StructuredParams.RepStablyNamedUObject);
					}
				}
				const improbable::unreal::UnrealObjectRef* ObjectRef = PackageMap->GetUnrealObjectRefFromNetGUID(NetGUID);
				if ((*ObjectRef) == SpatialConstants::UNRESOLVED_OBJECT_REF)
				{
					UE_LOG(LogSpatialGDKInterop, Log, TEXT("%s: RPC Server_ReportReplication queued. StructuredParams.RepStablyNamedUObject is unresolved."), *Interop->GetSpatialOS()->GetWorkerId());
					return {Cast<UObject>(StructuredParams.RepStablyNamedUObject)};
				}
				else
				{
					RPCPayload.set_field_repstablynameduobject0(*ObjectRef);
				}
			}
			else
			{
				RPCPayload.set_field_repstablynameduobject0(SpatialConstants::NULL_OBJECT_REF);
				//
			}
		}
		{
			if (StructuredParams.RepConstObj != nullptr)
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromObject(StructuredParams.RepConstObj);
				if (!NetGUID.IsValid())
				{
					if (StructuredParams.RepConstObj->IsFullNameStableForNetworking())
					{
						NetGUID = PackageMap->ResolveStablyNamedObject(StructuredParams.RepConstObj);
					}
				}
				const improbable::unreal::UnrealObjectRef* ObjectRef = PackageMap->GetUnrealObjectRefFromNetGUID(NetGUID);
				if ((*ObjectRef) == SpatialConstants::UNRESOLVED_OBJECT_REF)
				{
					UE_LOG(LogSpatialGDKInterop, Log, TEXT("%s: RPC Server_ReportReplication queued. StructuredParams.RepConstObj is unresolved."), *Interop->GetSpatialOS()->GetWorkerId());
					return {Cast<UObject>(StructuredParams.RepConstObj)};
				}
				else
				{
					RPCPayload.set_field_repconstobj0(*ObjectRef);
				}
			}
			else
			{
				RPCPayload.set_field_repconstobj0(SpatialConstants::NULL_OBJECT_REF);
				//
			}
		}
		...
		UE_LOG(LogSpatialGDKInterop, Verbose, TEXT("%s: Sending RPC: Server_ReportReplication, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverreportreplication>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_TestUObjectReplication::Server_ReportReplication_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverreportreplication>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		...
		// Declare parameters.
		// This struct is declared in TestUObjectReplication.generated.h (in a macro that is then put in TestUObjectReplication.h UCLASS macro)
		TestUObjectReplication_eventServer_ReportReplication_Parms Parameters;

		// Extract from request data.
		{
			improbable::unreal::UnrealObjectRef ObjectRef = Op.Request.field_repdynamicallycreatedactor0();
			check(ObjectRef != SpatialConstants::UNRESOLVED_OBJECT_REF);
			if (ObjectRef == SpatialConstants::NULL_OBJECT_REF)
			{
				//
				Parameters.RepDynamicallyCreatedActor = nullptr;
			}
			else
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				...
				if (NetGUID.IsValid())
				{
					...
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
					checkf(Cast<ATestActor>(Object_Raw), TEXT("Object ref %s maps to object %s with the wrong class."), *ObjectRefToString(ObjectRef), *Object_Raw->GetFullName());
					Parameters.RepDynamicallyCreatedActor = Cast<ATestActor>(Object_Raw);
				}
				else
				{
					// A legal static object reference should never be unresolved.
					checkf(ObjectRef.path().empty(), TEXT("A stably named object should not need resolution."));
					UE_LOG(LogSpatialGDKInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepDynamicallyCreatedActor %s is not resolved on this worker."),
						*Interop->GetSpatialOS()->GetWorkerId(),
						*ObjectRefToString(ObjectRef));
					return {ObjectRef};
				}
		...
		{
			improbable::unreal::UnrealObjectRef ObjectRef = Op.Request.field_repstablynameduobject0();
			check(ObjectRef != SpatialConstants::UNRESOLVED_OBJECT_REF);
			if (ObjectRef == SpatialConstants::NULL_OBJECT_REF)
			{
				//
				Parameters.RepStablyNamedUObject = nullptr;
			}
			else
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				...
				if (NetGUID.IsValid())
				{
					...
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
					checkf(Cast<UTestUObject>(Object_Raw), TEXT("Object ref %s maps to object %s with the wrong class."), *ObjectRefToString(ObjectRef), *Object_Raw->GetFullName());
					Parameters.RepStablyNamedUObject = Cast<UTestUObject>(Object_Raw);
				}
				else
				{
					// A legal static object reference should never be unresolved.
					checkf(ObjectRef.path().empty(), TEXT("A stably named object should not need resolution."));
					UE_LOG(LogSpatialGDKInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepStablyNamedUObject %s is not resolved on this worker."),
						*Interop->GetSpatialOS()->GetWorkerId(),
						*ObjectRefToString(ObjectRef));
					return {ObjectRef};
				}
		...
		{
			improbable::unreal::UnrealObjectRef ObjectRef = Op.Request.field_repconstobj0();
			check(ObjectRef != SpatialConstants::UNRESOLVED_OBJECT_REF);
			if (ObjectRef == SpatialConstants::NULL_OBJECT_REF)
			{
				//
				Parameters.RepConstObj = nullptr;
			}
			else
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				...
				if (NetGUID.IsValid())
				{
					...
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
					checkf(Cast<UTestUObject>(Object_Raw), TEXT("Object ref %s maps to object %s with the wrong class."), *ObjectRefToString(ObjectRef), *Object_Raw->GetFullName());
					Parameters.RepConstObj = Cast<UTestUObject>(Object_Raw);
				}
				else
				{
					// A legal static object reference should never be unresolved.
					checkf(ObjectRef.path().empty(), TEXT("A stably named object should not need resolution."));
					UE_LOG(LogSpatialGDKInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepConstObj %s is not resolved on this worker."),
						*Interop->GetSpatialOS()->GetWorkerId(),
						*ObjectRefToString(ObjectRef));
					return {ObjectRef};
				}
		...
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverreportreplication>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}

void USpatialTypeBinding_TestUObjectReplication::Server_ReportReplication_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverreportreplication>& Op)
{
