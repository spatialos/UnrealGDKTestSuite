...
void USpatialTypeBinding_TestFloatReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testfloatreplication::TestFloatReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestFloatReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testfloatreplication::TestFloatReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestFloatReplication& ParentValue = *(static_cast<ATestFloatReplication const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestFloatReplication&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestFloatReplication&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
...
void USpatialTypeBinding_TestFloatReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testfloatreplication::TestFloatReplicationHandoverData::Update& OutUpdate) const
{
}
