...
worker::Entity USpatialTypeBinding_TestCharReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientTestCharReplicationUpdate, bSingleClientTestCharReplicationUpdateChanged, MultiClientTestCharReplicationUpdate, bMultiClientTestCharReplicationUpdateChanged, TestCharReplicationHandoverDataUpdate, bTestCharReplicationHandoverDataUpdateChanged);
...
void USpatialTypeBinding_TestCharReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testcharreplication::TestCharReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestCharReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testcharreplication::TestCharReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestCharReplication& ParentValue = *(static_cast<ATestCharReplication const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestCharReplication&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestCharReplication&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
...
void USpatialTypeBinding_TestCharReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testcharreplication::TestCharReplicationHandoverData::Update& OutUpdate) const
{
}
