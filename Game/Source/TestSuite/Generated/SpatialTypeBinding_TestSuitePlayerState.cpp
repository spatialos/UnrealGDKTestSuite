...
worker::Entity USpatialTypeBinding_TestSuitePlayerState::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientTestSuitePlayerStateUpdate, bSingleClientTestSuitePlayerStateUpdateChanged, MultiClientTestSuitePlayerStateUpdate, bMultiClientTestSuitePlayerStateUpdateChanged, TestSuitePlayerStateHandoverDataUpdate, bTestSuitePlayerStateHandoverDataUpdateChanged);
...
void USpatialTypeBinding_TestSuitePlayerState::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
...
void USpatialTypeBinding_TestSuitePlayerState::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
...
void USpatialTypeBinding_TestSuitePlayerState::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testsuiteplayerstate::TestSuitePlayerStateSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestSuitePlayerState::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testsuiteplayerstate::TestSuitePlayerStateMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestSuitePlayerState& ParentValue = *(static_cast<ATestSuitePlayerState const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestSuitePlayerState&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestSuitePlayerState&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
...
void USpatialTypeBinding_TestSuitePlayerState::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testsuiteplayerstate::TestSuitePlayerStateHandoverData::Update& OutUpdate) const
{
}
