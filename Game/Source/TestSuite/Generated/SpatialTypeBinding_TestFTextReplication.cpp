...
void USpatialTypeBinding_TestFTextReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testftextreplication::TestFTextReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestFTextReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testftextreplication::TestFTextReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestFTextReplication& ParentValue = *(static_cast<ATestFTextReplication const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestFTextReplication&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestFTextReplication&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
...
void USpatialTypeBinding_TestFTextReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testftextreplication::TestFTextReplicationHandoverData::Update& OutUpdate) const
{
}
