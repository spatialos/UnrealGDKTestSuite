...
worker::Entity USpatialTypeBinding_TestMulticastRPC::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientTestMulticastRPCUpdate, bSingleClientTestMulticastRPCUpdateChanged, MultiClientTestMulticastRPCUpdate, bMultiClientTestMulticastRPCUpdateChanged, TestMulticastRPCHandoverDataUpdate, bTestMulticastRPCHandoverDataUpdateChanged);
...
void USpatialTypeBinding_TestMulticastRPC::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
...
void USpatialTypeBinding_TestMulticastRPC::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
...
void USpatialTypeBinding_TestMulticastRPC::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testmulticastrpc::TestMulticastRPCSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestMulticastRPC::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testmulticastrpc::TestMulticastRPCMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestMulticastRPC& ParentValue = *(static_cast<ATestMulticastRPC const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestMulticastRPC&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestMulticastRPC&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
...
void USpatialTypeBinding_TestMulticastRPC::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testmulticastrpc::TestMulticastRPCHandoverData::Update& OutUpdate) const
{
}
