...
worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_TestActor::GetInterestOverrideMap(bool bIsClient, bool bNetOwned) const
{
	worker::Map<worker::ComponentId, worker::InterestOverride> Interest;
	if (bIsClient)
	{
		Interest.emplace(improbable::unreal::generated::testactor::TestActorSingleClientRepData::ComponentId, worker::InterestOverride{bNetOwned});
		Interest.emplace(improbable::unreal::generated::testactor::TestActorHandoverData::ComponentId, worker::InterestOverride{false});
	}
	return Interest;
}

bool USpatialTypeBinding_TestActor::UpdateEntityACL(USpatialActorChannel* Channel, bool bNetOwned) const
{
	...
	if (PinnedConnection.IsValid() && PinnedView.IsValid())
	{
		...
		WriteACL[improbable::unreal::generated::testactor::TestActorClientRPCs::ComponentId] = OwningClientOnly;
...
void USpatialTypeBinding_TestActor::ServerSendUpdate_Handover(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testactor::TestActorHandoverData::Update& OutUpdate) const
{
}
