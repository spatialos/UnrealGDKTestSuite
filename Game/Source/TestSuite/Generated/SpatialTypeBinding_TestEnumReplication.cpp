...
const FHandoverHandlePropertyMap& USpatialTypeBinding_TestEnumReplication::GetHandoverHandlePropertyMap() const
{
...
void USpatialTypeBinding_TestEnumReplication::BindToView(bool bIsClient)
{
	...
	if (Interop->GetNetDriver()->GetNetMode() == NM_Client)
	{
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
...
worker::Entity USpatialTypeBinding_TestEnumReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	improbable::unreal::generated::testenumreplication::TestEnumReplicationSingleClientRepData::Data SingleClientTestEnumReplicationData;
	improbable::unreal::generated::testenumreplication::TestEnumReplicationSingleClientRepData::Update SingleClientTestEnumReplicationUpdate;
	bool bSingleClientTestEnumReplicationUpdateChanged = false;
	improbable::unreal::generated::testenumreplication::TestEnumReplicationMultiClientRepData::Data MultiClientTestEnumReplicationData;
	improbable::unreal::generated::testenumreplication::TestEnumReplicationMultiClientRepData::Update MultiClientTestEnumReplicationUpdate;
	bool bMultiClientTestEnumReplicationUpdateChanged = false;
	improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData::Data TestEnumReplicationHandoverData;
	improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData::Update TestEnumReplicationHandoverDataUpdate;
	bool bTestEnumReplicationHandoverDataUpdateChanged = false;

	BuildSpatialComponentUpdate(InitialChanges, Channel, SingleClientTestEnumReplicationUpdate, bSingleClientTestEnumReplicationUpdateChanged, MultiClientTestEnumReplicationUpdate, bMultiClientTestEnumReplicationUpdateChanged, TestEnumReplicationHandoverDataUpdate, bTestEnumReplicationHandoverDataUpdateChanged);
	SingleClientTestEnumReplicationUpdate.ApplyTo(SingleClientTestEnumReplicationData);
	MultiClientTestEnumReplicationUpdate.ApplyTo(MultiClientTestEnumReplicationData);
	TestEnumReplicationHandoverDataUpdate.ApplyTo(TestEnumReplicationHandoverData);
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::testenumreplication::TestEnumReplicationSingleClientRepData>(SingleClientTestEnumReplicationData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testenumreplication::TestEnumReplicationMultiClientRepData>(MultiClientTestEnumReplicationData, WorkersOnly)
...
void USpatialTypeBinding_TestEnumReplication::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData>(EntityId.ToSpatialEntityId(), HandoverDataUpdate);
	}
}
...
void USpatialTypeBinding_TestEnumReplication::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	...
	auto* HandoverDataAddOp = Cast<UTestEnumReplicationHandoverDataAddComponentOp>(AddComponentOp);
	if (HandoverDataAddOp)
	{
		auto Update = improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData::Update::FromInitialData(*HandoverDataAddOp->Data.data());
...
void USpatialTypeBinding_TestEnumReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testenumreplication::TestEnumReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestEnumReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testenumreplication::TestEnumReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ATestEnumReplication& ParentValue = *(static_cast<ATestEnumReplication const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestEnumReplication&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
				OutUpdate.set_field_owner0(SpatialConstants::NULL_OBJECT_REF);
				(const_cast<ATestEnumReplication&>(ParentValue)).Owner_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 14: // field_role0
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ATestEnumReplication&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
				OutUpdate.set_field_instigator0(SpatialConstants::NULL_OBJECT_REF);
				(const_cast<ATestEnumReplication&>(ParentValue)).Instigator_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
...
void USpatialTypeBinding_TestEnumReplication::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData::Update& OutUpdate) const
{
}
...
void USpatialTypeBinding_TestEnumReplication::ReceiveUpdate_Handover(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testenumreplication::TestEnumReplicationHandoverData::Update& Update) const
{
}
