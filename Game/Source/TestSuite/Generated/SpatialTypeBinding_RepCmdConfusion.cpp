...
{
	return ARepCmdConfusion::StaticClass();
}

void USpatialTypeBinding_RepCmdConfusion::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	Super::Init(InInterop, InPackageMap);


	UClass* Class = FindObject<UClass>(ANY_PACKAGE, TEXT("RepCmdConfusion"));
...
worker::Entity USpatialTypeBinding_RepCmdConfusion::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* ActorChannel) const
{
	...
	improbable::unreal::generated::repcmdconfusion::RepCmdConfusionSingleClientRepData::Data SingleClientRepCmdConfusionData;
	improbable::unreal::generated::repcmdconfusion::RepCmdConfusionSingleClientRepData::Update SingleClientRepCmdConfusionUpdate;
	bool bSingleClientRepCmdConfusionUpdateChanged = false;
	...
	BuildSpatialComponentUpdate(InitialChanges, ActorChannel, SingleClientRepCmdConfusionUpdate, bSingleClientRepCmdConfusionUpdateChanged, MultiClientRepCmdConfusionUpdate, bMultiClientRepCmdConfusionUpdateChanged, RepCmdConfusionHandoverDataUpdate, bRepCmdConfusionHandoverDataUpdateChanged);
...
void USpatialTypeBinding_RepCmdConfusion::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* ActorChannel, const FEntityId& EntityId) const
{
...
void USpatialTypeBinding_RepCmdConfusion::SendRPCCommand(UObject* TargetObject, const UFunction* const Function, void* Parameters)
{
	TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
...
void USpatialTypeBinding_RepCmdConfusion::ReceiveAddComponent(USpatialActorChannel* ActorChannel, UAddComponentOpWrapperBase* AddComponentOp) const
{
...
worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_RepCmdConfusion::GetInterestOverrideMap(bool bIsClient, bool bAutonomousProxy) const
{
...
void USpatialTypeBinding_RepCmdConfusion::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::repcmdconfusion::RepCmdConfusionSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_RepCmdConfusion::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::repcmdconfusion::RepCmdConfusionMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ARepCmdConfusion& ParentValue = *(static_cast<ARepCmdConfusion const*>(ActorChannel->Actor));
			...
			else
			{
				...
				//(const_cast<ARepCmdConfusion&>(ParentValue)).Owner_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
		case 14: // field_role0
		...
		case 15: // field_instigator0
		{
			...
			else
			{
				...
				//(const_cast<ARepCmdConfusion&>(ParentValue)).Instigator_Context = &SpatialConstants::NULL_OBJECT_REF;
			}
			break;
		}
	default:
...
void USpatialTypeBinding_RepCmdConfusion::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* ActorChannel, improbable::unreal::generated::repcmdconfusion::RepCmdConfusionHandoverData::Update& OutUpdate) const
{
}
...
void USpatialTypeBinding_RepCmdConfusion::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::repcmdconfusion::RepCmdConfusionMultiClientRepData::Update& Update) const
{
	...
	if (!Update.field_owner0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ARepCmdConfusion&>(ParentValue)).Owner_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
	...
	if (!Update.field_instigator0().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				FNetworkGUID NetGUID = PackageMap->GetNetGUIDFromUnrealObjectRef(ObjectRef);
				//(const_cast<ARepCmdConfusion&>(ParentValue)).Instigator_Context = PackageMap->GetUnrealObjectRefData(ObjectRef);
				if (NetGUID.IsValid())
				{
					UObject* Object_Raw = PackageMap->GetObjectFromNetGUID(NetGUID, true);
					checkf(Object_Raw, TEXT("An object ref %s should map to a valid object."), *ObjectRefToString(ObjectRef));
