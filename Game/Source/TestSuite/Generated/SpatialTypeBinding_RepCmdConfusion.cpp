...
worker::Entity USpatialTypeBinding_RepCmdConfusion::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
...
void USpatialTypeBinding_RepCmdConfusion::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::repcmdconfusion::RepCmdConfusionSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_RepCmdConfusion::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::repcmdconfusion::RepCmdConfusionMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		{
			AActor* Value = *(reinterpret_cast<AActor* const*>(Data));
			const ARepCmdConfusion& ParentValue = *(static_cast<ARepCmdConfusion const*>(Channel->Actor));
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ARepCmdConfusion&>(ParentValue)).Owner_Context = ObjectRef;
			}
			else
			{
		...
		case 15: // field_instigator0
		{
			...
			if (Value != nullptr)
			{
				...
				(const_cast<ARepCmdConfusion&>(ParentValue)).Instigator_Context = ObjectRef;
			}
			else
			{
...
void USpatialTypeBinding_RepCmdConfusion::ServerSendUpdate_Handover(const uint8* RESTRICT Data, const uint8* RESTRICT SourceData, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::repcmdconfusion::RepCmdConfusionHandoverData::Update& OutUpdate) const
{
}
