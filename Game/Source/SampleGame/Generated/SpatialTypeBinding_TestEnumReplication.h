...
private:
	...
	void ServerSendUpdate_Migratable(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testenumreplication::TestEnumReplicationMigratableData::Update& OutUpdate) const;
	...
	void ReceiveUpdate_Migratable(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testenumreplication::TestEnumReplicationMigratableData::Update& Update) const;
	...
	void Server_StartTest_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testenumreplication::TestEnumReplicationServerRPCs::Commands::Serverstarttest>& Op);
	...
	void Server_StartTest_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::testenumreplication::TestEnumReplicationServerRPCs::Commands::Serverstarttest>& Op);
};
