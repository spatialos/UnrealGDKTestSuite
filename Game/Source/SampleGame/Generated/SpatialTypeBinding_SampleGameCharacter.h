...
private:
	...
	void DoTheThingCStyleArray_SendCommand(worker::Connection* const Connection, void* Parameters, UObject* TargetObject);
	void DoTheThing_SendCommand(worker::Connection* const Connection, void* Parameters, UObject* TargetObject);
	...
	void DoTheThingCStyleArray_OnCommandRequest(const worker::CommandRequestOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothethingcstylearray>& Op);
	void DoTheThing_OnCommandRequest(const worker::CommandRequestOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothething>& Op);
	...
	void DoTheThingCStyleArray_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothethingcstylearray>& Op);
	void DoTheThing_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothething>& Op);
