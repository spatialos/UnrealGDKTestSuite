...
void USpatialTypeBinding_SampleGameCharacter::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	...
	RepHandleToPropertyMap.Add(6, FRepHandleData(Class, 1408760133, RepLayout, COND_SimulatedOrPhysicsNoReplay, REPNOTIFY_OnChanged));
	...
	RepHandleToPropertyMap.Add(17, FRepHandleData(Class, 2257018859, RepLayout, COND_SkipOwner, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(18, FRepHandleData(Class, 3014933975, RepLayout, COND_None, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(19, FRepHandleData(Class, 2861115847, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(20, FRepHandleData(Class, 1154827648, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(21, FRepHandleData(Class, 2178894591, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(22, FRepHandleData(Class, 3355827895, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(23, FRepHandleData(Class, 3794077805, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(24, FRepHandleData(Class, 2852819165, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(25, FRepHandleData(Class, 1479672970, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(26, FRepHandleData(Class, 861141471, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(27, FRepHandleData(Class, 1597493907, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(28, FRepHandleData(Class, 1086707127, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(29, FRepHandleData(Class, 3688318209, RepLayout, COND_SimulatedOnly, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(30, FRepHandleData(Class, 4195497010, RepLayout, COND_None, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(31, FRepHandleData(Class, 1418867210, RepLayout, COND_None, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(32, FRepHandleData(Class, 1416717995, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(33, FRepHandleData(Class, 3155265318, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(34, FRepHandleData(Class, 582822683, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(35, FRepHandleData(Class, 3840170756, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(36, FRepHandleData(Class, 507950469, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(37, FRepHandleData(Class, 4132354546, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(38, FRepHandleData(Class, 3856573721, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(39, FRepHandleData(Class, 588505551, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(40, FRepHandleData(Class, 1545679108, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(41, FRepHandleData(Class, 2333423598, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(42, FRepHandleData(Class, 1358972905, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
	RepHandleToPropertyMap.Add(43, FRepHandleData(Class, 3818389511, RepLayout, COND_SimulatedOnlyNoReplay, REPNOTIFY_OnChanged));
...
void USpatialTypeBinding_SampleGameCharacter::ServerSendUpdate_Migratable(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::samplegamecharacter::SampleGameCharacterMigratableData::Update& OutUpdate) const
{
	switch (Handle)
	{
		case 1: // field_charactermovement0_groundmovementmode0
		{
		...
		case 2: // field_charactermovement0_movementmode0
		{
			TEnumAsByte<EMovementMode> Value = *(reinterpret_cast<TEnumAsByte<EMovementMode> const*>(Data));
		...
		case 3: // field_charactermovement0_custommovementmode0
		{
			uint8 Value = *(reinterpret_cast<uint8 const*>(Data));
