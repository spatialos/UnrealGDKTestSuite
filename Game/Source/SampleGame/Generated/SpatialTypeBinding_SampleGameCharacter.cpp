...
void USpatialTypeBinding_SampleGameCharacter::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	...
	RPCToSenderMap.Emplace("DoTheThingCStyleArray", &USpatialTypeBinding_SampleGameCharacter::DoTheThingCStyleArray_SendCommand);
	RPCToSenderMap.Emplace("DoTheThing", &USpatialTypeBinding_SampleGameCharacter::DoTheThing_SendCommand);
...
void USpatialTypeBinding_SampleGameCharacter::BindToView()
{
	...
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Samplegamecharacterdothethingcstylearray>(std::bind(&USpatialTypeBinding_SampleGameCharacter::DoTheThingCStyleArray_OnCommandRequest, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Samplegamecharacterdothething>(std::bind(&USpatialTypeBinding_SampleGameCharacter::DoTheThing_OnCommandRequest, this, std::placeholders::_1)));
	...
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Samplegamecharacterdothethingcstylearray>(std::bind(&USpatialTypeBinding_SampleGameCharacter::DoTheThingCStyleArray_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Samplegamecharacterdothething>(std::bind(&USpatialTypeBinding_SampleGameCharacter::DoTheThing_OnCommandResponse, this, std::placeholders::_1)));
...
void USpatialTypeBinding_SampleGameCharacter::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::UnrealSampleGameCharacterMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		case 44: // field_cstyletestintarrayproperty0
		{
			int32 Value = *(reinterpret_cast<int32 const*>(Data));

			OutUpdate.set_field_cstyletestintarrayproperty0(int32_t(Value));
			break;
		}
		case 45: // field_cstyletestintarrayproperty1
		{
			int32 Value = *(reinterpret_cast<int32 const*>(Data));

			OutUpdate.set_field_cstyletestintarrayproperty1(int32_t(Value));
			break;
		}
		case 46: // field_cstyletestintarrayproperty2
		{
			int32 Value = *(reinterpret_cast<int32 const*>(Data));
...
void USpatialTypeBinding_SampleGameCharacter::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::UnrealSampleGameCharacterMultiClientRepData::Update& Update) const
{
	...
	if (!Update.field_cstyletestintarrayproperty0().empty())
	{
		// field_cstyletestintarrayproperty0
		uint16 Handle = 44;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = (*Update.field_cstyletestintarrayproperty0().data());
	...
	if (!Update.field_cstyletestintarrayproperty1().empty())
	{
		// field_cstyletestintarrayproperty1
		uint16 Handle = 45;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = (*Update.field_cstyletestintarrayproperty1().data());
	...
	if (!Update.field_cstyletestintarrayproperty2().empty())
	{
		// field_cstyletestintarrayproperty2
		uint16 Handle = 46;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
...
void USpatialTypeBinding_SampleGameCharacter::DoTheThingCStyleArray_SendCommand(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	...
	SampleGameCharacter_eventDoTheThingCStyleArray_Parms StructuredParams = *static_cast<SampleGameCharacter_eventDoTheThingCStyleArray_Parms*>(Parameters);
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		// Build request.
		improbable::unreal::generated::UnrealDoTheThingCStyleArrayRequest Request;
		Request.set_field_printme(TCHAR_TO_UTF8(*StructuredParams.PrintMe));
		Request.set_field_theteststructcstylearrayrpc_nonserializedint(int32_t(StructuredParams.TheTestStructCStyleArrayRPC.NonSerializedInt));
		Request.set_field_theteststructcstylearrayrpc_testint(int32_t(StructuredParams.TheTestStructCStyleArrayRPC.TestInt));
		{
			...
			Request.set_field_theteststructcstylearrayrpc_testintarray(List);
		}
		{
			...
			Request.set_field_theteststructcstylearrayrpc_netserializestruct(List);
		}
		{
			::worker::List<std::string> List;
		...
		UE_LOG(LogSpatialOSInterop, Verbose, TEXT("%s: Sending RPC: DoTheThingCStyleArray, target: %s %s"),
			...
			*TargetObject->GetName(),
			*ObjectRefToString(TargetObjectRef));
		auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothethingcstylearray>(TargetObjectRef.entity(), Request, 0);
		return {RequestId.Id};
	};
	Interop->SendCommandRequest_Internal(Sender, /*bReliable*/ true);
}

void USpatialTypeBinding_SampleGameCharacter::DoTheThing_SendCommand(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in SampleGameCharacter.generated.h (in a macro that is then put in SampleGameCharacter.h UCLASS macro)
	SampleGameCharacter_eventDoTheThing_Parms StructuredParams = *static_cast<SampleGameCharacter_eventDoTheThing_Parms*>(Parameters);
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		// Build request.
		improbable::unreal::generated::UnrealDoTheThingRequest Request;
		Request.set_field_printme(TCHAR_TO_UTF8(*StructuredParams.PrintMe));
		{
			TArray<uint8> ValueData;
			FMemoryWriter ValueDataWriter(ValueData);
			...
			checkf(bSuccess, TEXT("NetSerialize on FTestStruct failed."));
			Request.set_field_theteststructrpc(std::string(reinterpret_cast<char*>(ValueData.GetData()), ValueData.Num()));
		}
		...
		UE_LOG(LogSpatialOSInterop, Verbose, TEXT("%s: Sending RPC: DoTheThing, target: %s %s"),
			...
			*TargetObject->GetName(),
			*ObjectRefToString(TargetObjectRef));
		auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothething>(TargetObjectRef.entity(), Request, 0);
		return {RequestId.Id};
	};
	Interop->SendCommandRequest_Internal(Sender, /*bReliable*/ true);
}
...
void USpatialTypeBinding_SampleGameCharacter::DoTheThingCStyleArray_OnCommandRequest(const worker::CommandRequestOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothethingcstylearray>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset()};
		...
		if (!TargetNetGUID.IsValid())
		{
			UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: DoTheThingCStyleArray_OnCommandRequest: Target object %s is not resolved on this worker."),
				*Interop->GetSpatialOS()->GetWorkerId(),
				*ObjectRefToString(TargetObjectRef));
			return {TargetObjectRef};
		}
		UObject* TargetObject = PackageMap->GetObjectFromNetGUID(TargetNetGUID, false);
		checkf(TargetObject, TEXT("%s: DoTheThingCStyleArray_OnCommandRequest: Object Ref %s (NetGUID %s) does not correspond to a UObject."),
			*Interop->GetSpatialOS()->GetWorkerId(),
			*ObjectRefToString(TargetObjectRef),
			*TargetNetGUID.ToString());
		...
		// Declare parameters.
		// This struct is declared in SampleGameCharacter.generated.h (in a macro that is then put in SampleGameCharacter.h UCLASS macro)
		SampleGameCharacter_eventDoTheThingCStyleArray_Parms Parameters;

		// Extract from request data.
		Parameters.PrintMe = FString(UTF8_TO_TCHAR(Op.Request.field_printme().c_str()));
		Parameters.TheTestStructCStyleArrayRPC.NonSerializedInt = Op.Request.field_theteststructcstylearrayrpc_nonserializedint();
		Parameters.TheTestStructCStyleArrayRPC.TestInt = Op.Request.field_theteststructcstylearrayrpc_testint();
		{
			auto& List = Op.Request.field_theteststructcstylearrayrpc_testintarray();
		...
		{
			auto& List = Op.Request.field_theteststructcstylearrayrpc_netserializestruct();
			for(int i = 0; i < List.size(); i++)
			{
				{
		...
		{
			auto& List = Op.Request.field_theteststructcstylearrayrpc_nonetserializestruct();
			for(int i = 0; i < List.size(); i++)
			{
				auto& ValueDataStr = List[i];
				TArray<uint8> ValueData;
		...
		{
			auto& List = Op.Request.field_dynamicstructarrayrpc();
		...
		{
			UE_LOG(LogSpatialOSInterop, Error, TEXT("%s: DoTheThingCStyleArray_OnCommandRequest: Function not found. Object: %s, Function: DoTheThingCStyleArray."),
				*Interop->GetSpatialOS()->GetWorkerId(),
				*TargetObject->GetFullName());
		}
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothethingcstylearray>(Op.RequestId, {});
		return {};
	};
	Interop->SendCommandResponse_Internal(Receiver);
}

void USpatialTypeBinding_SampleGameCharacter::DoTheThing_OnCommandRequest(const worker::CommandRequestOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothething>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset()};
		...
		if (!TargetNetGUID.IsValid())
		{
			UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: DoTheThing_OnCommandRequest: Target object %s is not resolved on this worker."),
				*Interop->GetSpatialOS()->GetWorkerId(),
				*ObjectRefToString(TargetObjectRef));
			return {TargetObjectRef};
		}
		UObject* TargetObject = PackageMap->GetObjectFromNetGUID(TargetNetGUID, false);
		checkf(TargetObject, TEXT("%s: DoTheThing_OnCommandRequest: Object Ref %s (NetGUID %s) does not correspond to a UObject."),
			*Interop->GetSpatialOS()->GetWorkerId(),
			*ObjectRefToString(TargetObjectRef),
			*TargetNetGUID.ToString());
		...
		// Declare parameters.
		// This struct is declared in SampleGameCharacter.generated.h (in a macro that is then put in SampleGameCharacter.h UCLASS macro)
		SampleGameCharacter_eventDoTheThing_Parms Parameters;

		// Extract from request data.
		Parameters.PrintMe = FString(UTF8_TO_TCHAR(Op.Request.field_printme().c_str()));
		{
			auto& ValueDataStr = Op.Request.field_theteststructrpc();
			TArray<uint8> ValueData;
			ValueData.Append(reinterpret_cast<const uint8*>(ValueDataStr.data()), ValueDataStr.size());
			FMemoryReader ValueDataReader(ValueData);
			bool bSuccess = true;
		...
		{
			UE_LOG(LogSpatialOSInterop, Error, TEXT("%s: DoTheThing_OnCommandRequest: Function not found. Object: %s, Function: DoTheThing."),
				*Interop->GetSpatialOS()->GetWorkerId(),
				*TargetObject->GetFullName());
		}
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothething>(Op.RequestId, {});
		return {};
	};
	Interop->SendCommandResponse_Internal(Receiver);
}
...
void USpatialTypeBinding_SampleGameCharacter::DoTheThingCStyleArray_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothethingcstylearray>& Op)
{
...
void USpatialTypeBinding_SampleGameCharacter::DoTheThing_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::UnrealSampleGameCharacterServerRPCs::Commands::Samplegamecharacterdothething>& Op)
{
