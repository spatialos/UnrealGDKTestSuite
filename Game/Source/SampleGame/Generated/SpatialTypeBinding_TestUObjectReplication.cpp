...
void USpatialTypeBinding_TestUObjectReplication::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	...
	RPCToSenderMap.Emplace("Server_StartTest", &USpatialTypeBinding_TestUObjectReplication::Server_StartTest_SendRPC);
...
void USpatialTypeBinding_TestUObjectReplication::BindToView(bool bIsClient)
{
	...
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Serverstarttest>(std::bind(&USpatialTypeBinding_TestUObjectReplication::Server_StartTest_OnRPCPayload, this, std::placeholders::_1)));
	...
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Serverstarttest>(std::bind(&USpatialTypeBinding_TestUObjectReplication::Server_StartTest_OnCommandResponse, this, std::placeholders::_1)));
}
...
worker::Entity USpatialTypeBinding_TestUObjectReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	// Setup initial data.
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData::Data SingleClientData;
	...
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData::Data MultiClientData;
	...
	improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMigratableData::Data MigratableData;
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationSingleClientRepData>(SingleClientData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMultiClientRepData>(MultiClientData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationMigratableData>(MigratableData, WorkersOnly)
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		improbable::unreal::generated::testuobjectreplication::ServerReportReplicationRequest RPCPayload;
		{
			if (StructuredParams.RepDynamicallyCreatedActor != nullptr)
			{
				...
				if (ObjectRef == SpatialConstants::UNRESOLVED_OBJECT_REF)
				{
					UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: RPC Server_ReportReplication queued. StructuredParams.RepDynamicallyCreatedActor is unresolved."), *Interop->GetSpatialOS()->GetWorkerId());
		...
		}
		{
			if (StructuredParams.RepStablyNamedUObject != nullptr)
			{
				...
				if (ObjectRef == SpatialConstants::UNRESOLVED_OBJECT_REF)
				{
					UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: RPC Server_ReportReplication queued. StructuredParams.RepStablyNamedUObject is unresolved."), *Interop->GetSpatialOS()->GetWorkerId());
...
void USpatialTypeBinding_TestUObjectReplication::Server_StartTest_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialOSInterop, Verbose, TEXT("%s: Sending RPC: Server_StartTest, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverstarttest>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
		...
		// Extract from request data.
		{
			...
			else
			{
				...
				else
				{
					...
					UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepDynamicallyCreatedActor %s is not resolved on this worker."),
						*Interop->GetSpatialOS()->GetWorkerId(),
						*ObjectRefToString(ObjectRef));
					return {ObjectRef};
				}
		...
		}
		{
			...
			else
			{
				...
				else
				{
					// A legal static object reference should never be unresolved.
					checkf(ObjectRef.path().empty(), TEXT("A stably named object should not need resolution."));
					UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepStablyNamedUObject %s is not resolved on this worker."),
						*Interop->GetSpatialOS()->GetWorkerId(),
						*ObjectRefToString(ObjectRef));
					return {ObjectRef};
				}
...
void USpatialTypeBinding_TestUObjectReplication::Server_StartTest_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverstarttest>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverstarttest>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
...
void USpatialTypeBinding_TestUObjectReplication::Server_StartTest_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::testuobjectreplication::TestUObjectReplicationServerRPCs::Commands::Serverstarttest>& Op)
{
