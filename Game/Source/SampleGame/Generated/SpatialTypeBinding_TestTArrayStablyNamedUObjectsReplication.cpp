...
#include "SpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication.h"
...
#include "TestTArrayStablyNamedUObjectsReplicationSingleClientRepDataAddComponentOp.h"
#include "TestTArrayStablyNamedUObjectsReplicationMultiClientRepDataAddComponentOp.h"
#include "TestTArrayStablyNamedUObjectsReplicationMigratableDataAddComponentOp.h"

const FRepHandlePropertyMap& USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::GetRepHandlePropertyMap() const
{
	return RepHandleToPropertyMap;
}

const FMigratableHandlePropertyMap& USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::GetMigratableHandlePropertyMap() const
{
	return MigratableHandleToPropertyMap;
}

UClass* USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::GetBoundClass() const
{
	return ATestTArrayStablyNamedUObjectsReplication::StaticClass();
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Init(USpatialInterop* InInterop, USpatialPackageMapClient* InPackageMap)
{
	Super::Init(InInterop, InPackageMap);

	RPCToSenderMap.Emplace("Server_ReportReplication", &USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_ReportReplication_SendRPC);
	RPCToSenderMap.Emplace("Server_StartTest", &USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_StartTest_SendRPC);

	UClass* Class = FindObject<UClass>(ANY_PACKAGE, TEXT("TestTArrayStablyNamedUObjectsReplication"));
	...
	RepHandleToPropertyMap.Add(17, FRepHandleData(Class, {"StablyNamedArray"}, COND_None, REPNOTIFY_OnChanged, 0));
	RepHandleToPropertyMap.Add(18, FRepHandleData(Class, {"DynamicallyCreatedArray"}, COND_None, REPNOTIFY_OnChanged, 0));
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::BindToView(bool bIsClient)
{
	...
	{
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData::ComponentId))
			{
				return;
			}
		...
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData::ComponentId))
			{
				return;
			}
			USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
	...
	ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationNetMulticastRPCs>([this](
		const worker::ComponentUpdateOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationNetMulticastRPCs>& Op)
	{
		// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
		if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationNetMulticastRPCs::ComponentId))
		{
			return;
		}
	...
	using ServerRPCCommandTypes = improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands;
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Serverreportreplication>(std::bind(&USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_ReportReplication_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandRequest<ServerRPCCommandTypes::Serverstarttest>(std::bind(&USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_StartTest_OnRPCPayload, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Serverreportreplication>(std::bind(&USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_ReportReplication_OnCommandResponse, this, std::placeholders::_1)));
	ViewCallbacks.Add(View->OnCommandResponse<ServerRPCCommandTypes::Serverstarttest>(std::bind(&USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_StartTest_OnCommandResponse, this, std::placeholders::_1)));
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::UnbindFromView()
{
	ViewCallbacks.Reset();
}

worker::Entity USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	// Setup initial data.
	improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData::Data SingleClientData;
	...
	improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData::Data MultiClientData;
	...
	improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData::Data MigratableData;
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData>(SingleClientData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData>(MultiClientData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData>(MigratableData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationClientRPCs>(improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationClientRPCs::Data{}, OwningClientOnly)
		.AddComponent<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs>(improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Data{}, WorkersOnly)
		.AddComponent<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationNetMulticastRPCs>(improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationNetMulticastRPCs::Data{}, WorkersOnly)
		.Build();
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData>(EntityId.ToSpatialEntityId(), SingleClientUpdate);
	}
	if (bMultiClientUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData>(EntityId.ToSpatialEntityId(), MultiClientUpdate);
	}
	if (bMigratableDataUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData>(EntityId.ToSpatialEntityId(), MigratableDataUpdate);
	}
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::SendRPCCommand(UObject* TargetObject, const UFunction* const Function, void* Parameters)
{
	TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
...
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ReceiveAddComponent(USpatialActorChannel* Channel, UAddComponentOpWrapperBase* AddComponentOp) const
{
	auto* SingleClientAddOp = Cast<UTestTArrayStablyNamedUObjectsReplicationSingleClientRepDataAddComponentOp>(AddComponentOp);
	if (SingleClientAddOp)
	{
		auto Update = improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData::Update::FromInitialData(*SingleClientAddOp->Data.data());
		ReceiveUpdate_SingleClient(Channel, Update);
	}
	auto* MultiClientAddOp = Cast<UTestTArrayStablyNamedUObjectsReplicationMultiClientRepDataAddComponentOp>(AddComponentOp);
	if (MultiClientAddOp)
	{
		auto Update = improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData::Update::FromInitialData(*MultiClientAddOp->Data.data());
		ReceiveUpdate_MultiClient(Channel, Update);
	}
	auto* MigratableDataAddOp = Cast<UTestTArrayStablyNamedUObjectsReplicationMigratableDataAddComponentOp>(AddComponentOp);
	if (MigratableDataAddOp)
	{
		auto Update = improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData::Update::FromInitialData(*MigratableDataAddOp->Data.data());
		ReceiveUpdate_Migratable(Channel, Update);
	}
}

worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::GetInterestOverrideMap(bool bIsClient, bool bAutonomousProxy) const
{
	...
	if (bIsClient)
	{
		if (!bAutonomousProxy)
		{
			Interest.emplace(improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData::ComponentId, worker::InterestOverride{false});
		}
		Interest.emplace(improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData::ComponentId, worker::InterestOverride{false});
	}
	return Interest;
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::BuildSpatialComponentUpdate(
...
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		case 17: // field_stablynamedarray
		{
			...
			{
				OutUpdate.set_field_stablynamedarray(List);
			}
			else
			{
		...
		case 18: // field_dynamicallycreatedarray
		{
			...
			if (UnresolvedObjects.Num() == 0)
			{
				OutUpdate.set_field_dynamicallycreatedarray(List);
			}
			else
			{
...
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ServerSendUpdate_Migratable(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ReceiveUpdate_SingleClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationSingleClientRepData::Update& Update) const
{
...
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMultiClientRepData::Update& Update) const
{
	Interop->PreReceiveSpatialUpdate(ActorChannel);
	TSet<UProperty*> RepNotifies;

	const bool bIsServer = Interop->GetNetDriver()->IsServer();
	const bool bAutonomousProxy = ActorChannel->IsClientAutonomousProxy(improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationClientRPCs::ComponentId);
	...
	if (!Update.field_stablynamedarray().empty())
	{
		// field_stablynamedarray
		uint16 Handle = 17;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				auto& List = (*Update.field_stablynamedarray().data());
	...
	if (!Update.field_dynamicallycreatedarray().empty())
	{
		// field_dynamicallycreatedarray
		uint16 Handle = 18;
		const FRepHandleData* RepData = &HandleToPropertyMap[Handle];
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			{
				auto& List = (*Update.field_dynamicallycreatedarray().data());
				Value.SetNum(List.size());
				for(int i = 0; i < List.size(); i++)
				{
					{
...
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ReceiveUpdate_Migratable(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationMigratableData::Update& Update) const
{
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::ReceiveUpdate_NetMulticastRPCs(worker::EntityId EntityId, const improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationNetMulticastRPCs::Update& Update)
{
}
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_ReportReplication_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	// This struct is declared in TestTArrayStablyNamedUObjectsReplication.generated.h (in a macro that is then put in TestTArrayStablyNamedUObjectsReplication.h UCLASS macro)
	TestTArrayStablyNamedUObjectsReplication_eventServer_ReportReplication_Parms StructuredParams = *static_cast<TestTArrayStablyNamedUObjectsReplication_eventServer_ReportReplication_Parms*>(Parameters);
	...
	auto Sender = [this, Connection, TargetObject, StructuredParams]() mutable -> FRPCCommandRequestResult
	{
		...
		// Build RPC Payload.
		improbable::unreal::generated::testtarraystablynameduobjectsreplication::ServerReportReplicationRequest RPCPayload;
		::worker::List<improbable::unreal::UnrealObjectRef> List;
		...
		RPCPayload.set_field_repstablynamedarray(List);
		::worker::List<improbable::unreal::UnrealObjectRef> List;
		...
		RPCPayload.set_field_repdynamicallycreatedactors(List);
		...
		UE_LOG(LogSpatialOSInterop, Verbose, TEXT("%s: Sending RPC: Server_ReportReplication, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverreportreplication>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_StartTest_SendRPC(worker::Connection* const Connection, void* Parameters, UObject* TargetObject)
{
	auto Sender = [this, Connection, TargetObject]() mutable -> FRPCCommandRequestResult
	{
		...
		UE_LOG(LogSpatialOSInterop, Verbose, TEXT("%s: Sending RPC: Server_StartTest, target: %s %s"),
			...
			*ObjectRefToString(TargetObjectRef));
			...
			auto RequestId = Connection->SendCommandRequest<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverstarttest>(TargetObjectRef.entity(), RPCPayload, 0);
			return {RequestId.Id};
	};
	Interop->InvokeRPCSendHandler_Internal(Sender, /*bReliable*/ true);
}
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_ReportReplication_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverreportreplication>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		...
		// Declare parameters.
		// This struct is declared in TestTArrayStablyNamedUObjectsReplication.generated.h (in a macro that is then put in TestTArrayStablyNamedUObjectsReplication.h UCLASS macro)
		TestTArrayStablyNamedUObjectsReplication_eventServer_ReportReplication_Parms Parameters;

		// Extract from request data.
		{
			auto& List = Op.Request.field_repstablynamedarray();
			...
			{
				{
					...
					else
					{
						...
						else
						{
							...
							UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepStablyNamedArray[i] %s is not resolved on this worker."),
								*Interop->GetSpatialOS()->GetWorkerId(),
								*ObjectRefToString(ObjectRef));
							return {ObjectRef};
						}
		...
		{
			auto& List = Op.Request.field_repdynamicallycreatedactors();
			...
			{
				{
					...
					else
					{
						...
						else
						{
							// A legal static object reference should never be unresolved.
							checkf(ObjectRef.path().empty(), TEXT("A stably named object should not need resolution."));
							UE_LOG(LogSpatialOSInterop, Log, TEXT("%s: Server_ReportReplication_OnRPCPayload: Parameters.RepDynamicallyCreatedActors[i] %s is not resolved on this worker."),
								*Interop->GetSpatialOS()->GetWorkerId(),
								*ObjectRefToString(ObjectRef));
							return {ObjectRef};
						}
		...
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverreportreplication>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_StartTest_OnRPCPayload(const worker::CommandRequestOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverstarttest>& Op)
{
	auto Receiver = [this, Op]() mutable -> FRPCCommandResponseResult
	{
		improbable::unreal::UnrealObjectRef TargetObjectRef{Op.EntityId, Op.Request.target_subobject_offset(), {}, {}};
		...
		// Send command response.
		TSharedPtr<worker::Connection> Connection = Interop->GetSpatialOS()->GetConnection().Pin();
		Connection->SendCommandResponse<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverstarttest>(Op.RequestId, {});
		return {};
	};
	Interop->InvokeRPCReceiveHandler_Internal(Receiver);
}

void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_ReportReplication_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverreportreplication>& Op)
{
...
void USpatialTypeBinding_TestTArrayStablyNamedUObjectsReplication::Server_StartTest_OnCommandResponse(const worker::CommandResponseOp<improbable::unreal::generated::testtarraystablynameduobjectsreplication::TestTArrayStablyNamedUObjectsReplicationServerRPCs::Commands::Serverstarttest>& Op)
{
