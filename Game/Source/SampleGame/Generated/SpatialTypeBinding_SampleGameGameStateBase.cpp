...
#include "UnrealSampleGameGameStateBaseSingleClientRepDataAddComponentOp.h"
#include "UnrealSampleGameGameStateBaseMultiClientRepDataAddComponentOp.h"
#include "UnrealSampleGameGameStateBaseMigratableDataAddComponentOp.h"
...
void USpatialTypeBinding_SampleGameGameStateBase::BindToView(bool bIsClient)
{
	...
	{
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::ComponentId))
			{
				return;
			}
		...
		ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData>([this](
			const worker::ComponentUpdateOp<improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData>& Op)
		{
			// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
			if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData::ComponentId))
			{
				return;
			}
			USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
		...
		if (!bIsClient)
		{
			ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData>([this](
				const worker::ComponentUpdateOp<improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData>& Op)
			{
				// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
				if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData::ComponentId))
				{
					return;
				}
				USpatialActorChannel* ActorChannel = Interop->GetActorChannelByEntityId(Op.EntityId);
	...
	ViewCallbacks.Add(View->OnComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseNetMulticastRPCs>([this](
		const worker::ComponentUpdateOp<improbable::unreal::generated::UnrealSampleGameGameStateBaseNetMulticastRPCs>& Op)
	{
		// TODO: Remove this check once we can disable component update short circuiting. This will be exposed in 14.0. See TIG-137.
		if (HasComponentAuthority(Interop->GetSpatialOS()->GetView(), Op.EntityId, improbable::unreal::generated::UnrealSampleGameGameStateBaseNetMulticastRPCs::ComponentId))
		{
			return;
		}
...
worker::Entity USpatialTypeBinding_SampleGameGameStateBase::CreateActorEntity(const FString& ClientWorkerId, const FVector& Position, const FString& Metadata, const FPropertyChangeState& InitialChanges, USpatialActorChannel* Channel) const
{
	...
	// Setup initial data.
	improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::Data SingleClientData;
	improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::Update SingleClientUpdate;
	bool bSingleClientUpdateChanged = false;
	improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData::Data MultiClientData;
	improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData::Update MultiClientUpdate;
	bool bMultiClientUpdateChanged = false;
	improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData::Data MigratableData;
	...
	return improbable::unreal::FEntityBuilder::Begin()
		...
		.AddComponent<improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData>(SingleClientData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData>(MultiClientData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData>(MigratableData, WorkersOnly)
		.AddComponent<improbable::unreal::generated::UnrealSampleGameGameStateBaseClientRPCs>(improbable::unreal::generated::UnrealSampleGameGameStateBaseClientRPCs::Data{}, OwningClientOnly)
		.AddComponent<improbable::unreal::generated::UnrealSampleGameGameStateBaseServerRPCs>(improbable::unreal::generated::UnrealSampleGameGameStateBaseServerRPCs::Data{}, WorkersOnly)
		.AddComponent<improbable::unreal::generated::UnrealSampleGameGameStateBaseNetMulticastRPCs>(improbable::unreal::generated::UnrealSampleGameGameStateBaseNetMulticastRPCs::Data{}, WorkersOnly)
		.Build();
}
...
void USpatialTypeBinding_SampleGameGameStateBase::SendComponentUpdates(const FPropertyChangeState& Changes, USpatialActorChannel* Channel, const FEntityId& EntityId) const
{
	...
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData>(EntityId.ToSpatialEntityId(), SingleClientUpdate);
	}
	if (bMultiClientUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData>(EntityId.ToSpatialEntityId(), MultiClientUpdate);
	}
	if (bMigratableDataUpdateChanged)
	{
		Connection->SendComponentUpdate<improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData>(EntityId.ToSpatialEntityId(), MigratableDataUpdate);
	}
}
...
{
	auto* SingleClientAddOp = Cast<UUnrealSampleGameGameStateBaseSingleClientRepDataAddComponentOp>(AddComponentOp);
	if (SingleClientAddOp)
	{
		auto Update = improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::Update::FromInitialData(*SingleClientAddOp->Data.data());
		ReceiveUpdate_SingleClient(Channel, Update);
	}
	auto* MultiClientAddOp = Cast<UUnrealSampleGameGameStateBaseMultiClientRepDataAddComponentOp>(AddComponentOp);
	if (MultiClientAddOp)
	{
		auto Update = improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData::Update::FromInitialData(*MultiClientAddOp->Data.data());
		ReceiveUpdate_MultiClient(Channel, Update);
	}
	auto* MigratableDataAddOp = Cast<UUnrealSampleGameGameStateBaseMigratableDataAddComponentOp>(AddComponentOp);
	if (MigratableDataAddOp)
	{
		auto Update = improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData::Update::FromInitialData(*MigratableDataAddOp->Data.data());
...
worker::Map<worker::ComponentId, worker::InterestOverride> USpatialTypeBinding_SampleGameGameStateBase::GetInterestOverrideMap(bool bIsClient, bool bAutonomousProxy) const
{
	...
	if (bIsClient)
	{
		if (!bAutonomousProxy)
		{
			Interest.emplace(improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::ComponentId, worker::InterestOverride{false});
		}
		Interest.emplace(improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData::ComponentId, worker::InterestOverride{false});
	}
	return Interest;
}
...
void USpatialTypeBinding_SampleGameGameStateBase::ServerSendUpdate_SingleClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_SampleGameGameStateBase::ServerSendUpdate_MultiClient(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData::Update& OutUpdate) const
{
	switch (Handle)
	{
		...
		case 16: // field_gamemodeclass
		{
			...
			OutUpdate.set_field_gamemodeclass(PackageMap->GetHashFromStaticClass(Value));
			break;
		}
		case 17: // field_spectatorclass
		{
			...
			OutUpdate.set_field_spectatorclass(PackageMap->GetHashFromStaticClass(Value));
			break;
		}
...
void USpatialTypeBinding_SampleGameGameStateBase::ServerSendUpdate_Migratable(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData::Update& OutUpdate) const
{
}

void USpatialTypeBinding_SampleGameGameStateBase::ReceiveUpdate_SingleClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::UnrealSampleGameGameStateBaseSingleClientRepData::Update& Update) const
{
...
void USpatialTypeBinding_SampleGameGameStateBase::ReceiveUpdate_MultiClient(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::UnrealSampleGameGameStateBaseMultiClientRepData::Update& Update) const
{
	Interop->PreReceiveSpatialUpdate(ActorChannel);
	TSet<UProperty*> RepNotifies;

	const bool bIsServer = Interop->GetNetDriver()->IsServer();
	const bool bAutonomousProxy = ActorChannel->IsClientAutonomousProxy(improbable::unreal::generated::UnrealSampleGameGameStateBaseClientRPCs::ComponentId);
	...
	if (!Update.field_gamemodeclass().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = PackageMap->GetStaticClassFromHash((*Update.field_gamemodeclass().data()));
	...
	if (!Update.field_spectatorclass().empty())
	{
		...
		if (bIsServer || ConditionMap.IsRelevant(RepData->Condition))
		{
			...
			Value = PackageMap->GetStaticClassFromHash((*Update.field_spectatorclass().data()));
...
void USpatialTypeBinding_SampleGameGameStateBase::ReceiveUpdate_Migratable(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::UnrealSampleGameGameStateBaseMigratableData::Update& Update) const
{
}

void USpatialTypeBinding_SampleGameGameStateBase::ReceiveUpdate_NetMulticastRPCs(worker::EntityId EntityId, const improbable::unreal::generated::UnrealSampleGameGameStateBaseNetMulticastRPCs::Update& Update)
{
}
