...
private:
	...
	void ServerSendUpdate_Migratable(const uint8* RESTRICT Data, int32 Handle, UProperty* Property, USpatialActorChannel* Channel, improbable::unreal::generated::testfnamereplication::TestFNameReplicationMigratableData::Update& OutUpdate) const;
	...
	void ReceiveUpdate_Migratable(USpatialActorChannel* ActorChannel, const improbable::unreal::generated::testfnamereplication::TestFNameReplicationMigratableData::Update& Update) const;
