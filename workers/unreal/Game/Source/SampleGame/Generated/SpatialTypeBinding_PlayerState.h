...
class USpatialTypeBinding_PlayerState : public USpatialTypeBinding
{
  ...
  private:
    ...
    // RPC to sender map.
    using FRPCSender = void (USpatialTypeBinding_PlayerState::*)(worker::Connection* const,
    ...
    void ServerSendUpdate_Migratable(
        const uint8* RESTRICT Data, int32 Handle, UProperty* Property,
        USpatialActorChannel* Channel,
        improbable::unreal::UnrealPlayerStateMigratableData::Update& OutUpdate) const;
    ...
    void ReceiveUpdate_Migratable(
        USpatialActorChannel* ActorChannel,
        const improbable::unreal::UnrealPlayerStateMigratableData::Update& Update) const;
