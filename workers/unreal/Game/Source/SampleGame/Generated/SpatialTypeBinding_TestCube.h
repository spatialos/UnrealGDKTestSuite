...
private:
	...
	// RPC to sender map.
	using FRPCSender = void (USpatialTypeBinding_TestCube::*)(worker::Connection* const, struct FFrame* const, UObject*);
	...
	void ServerInteract_SendCommand(worker::Connection* const Connection, struct FFrame* const RPCFrame, UObject* TargetObject);
