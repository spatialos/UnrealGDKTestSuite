...
set SPATIALGDK_CODEGENPATH="%1\CodeGeneration"
...
rmdir "%~dp0\workers\unreal\Game\Binaries\ThirdParty\Improbable\CodeGeneration" 2>NUL
...
if not exist %~dp0\workers\unreal\Game\Binaries\ThirdParty\Improbable\ (
	mkdir %~dp0\workers\unreal\Game\Binaries\ThirdParty\Improbable\
)
...
mklink /J "%~dp0\workers\unreal\Game\Binaries\ThirdParty\Improbable\CodeGeneration" %SPATIALGDK_CODEGENPATH%
